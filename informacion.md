...
## 1. Bocetacion visual y wireframes
...
+------------------------------------------------------+
|  +-------------------------+  +--------------------+ |
|  | Jugadores activos       |  | Invitaciones       | |
|  |-------------------------|  |--------------------| |
|  | Jugador1    [Invitar]   |  | Jugador2  [✓] [✕]  | |
|  | Jugador2    [Invitar]   |  | Jugador3  [✓] [✕]  | |
|  | ...                     |  | ...                | |
|  +-------------------------+  +--------------------+ |
+------------------------------------------------------+
```
...
## 2. Guia de estilo y sistema de diseno
